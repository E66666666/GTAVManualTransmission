...
bool CheckUpdate(ReleaseInfo& relInfo) {
    ...
    std::string url = std::format("https://api.github.com/repos/{}/{}/releases/latest", "E66666666", "GTAVManualTransmission");
    std::string ua = std::format("E66666666/MT{}", Constants::DisplayVersion);
